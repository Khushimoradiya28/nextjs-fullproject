  ...
  return (<div>
    ...
    <div style={{background:"#fff",border:"1px solid #e5e5e0",borderRadius:"12px",padding:"28px 32px",maxWidth:"650px"}}>
      ...
      <div style={{display:"flex",alignItems:"center",gap:"20px",marginBottom:"24px",paddingBottom:"20px",borderBottom:"1px solid #f0f0ea"}}>
        ...
        <div><label style={{padding:"8px 16px",background:"#fff",border:"1.5px solid #e5e5e0",borderRadius:"8px",fontSize:"13px",fontWeight:"600",color:"#111",cursor:"pointer",display:"inline-block"}}>Change Logo<input type="file" accept="image/*" onChange={handleLogoUpload} style={{display:"none"}}/></label><p style={{fontSize:"11px",color:"#aaa",margin:"6px 0 0"}}>PNG, JPG up to 2MB</p></div>
      </div>
