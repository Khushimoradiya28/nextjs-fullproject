...
export default function AllOffersTab({
  offers,
  handleDeleteOffer,
  showAddForm,
  setShowAddForm,
    ...
    <div>
      ...
      {showAddForm && (
        ...
        >
          ...
          >
            <div
              style={{ borderLeft: "4px solid #1a6fd4", paddingLeft: "14px" }}
            >
              <h3
                style={{
                  fontSize: "16px",
              ...
              >
                Set interest rate and loan parameters
              </p>
            </div>
            <button
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewOffer({ ...newOffer, processingFee: e.target.value })
                }
                style={inputStyle}
                onFocus={focusIn}
                onBlur={focusOut}
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setNewOffer({ ...newOffer, loanType: e.target.value })
                }
            ...
            <div>
              <label style={labelStyle}>Max Tenure (years)</label>
              <input
                type="number"
                placeholder="e.g. 30"
                value={newOffer.maxTenure}
                onChange={(e) =>
                  setNewOffer({ ...newOffer, maxTenure: e.target.value })
                }
                style={inputStyle}
                onFocus={focusIn}
                onBlur={focusOut}
          ...
          <div style={{ marginTop: "20px" }}>
            ...
            <input
              type="text"
              placeholder="e.g. No prepayment charges, Doorstep service"
              value={newOffer.features}
              onChange={(e) =>
                setNewOffer({ ...newOffer, features: e.target.value })
              }
              style={inputStyle}
              onFocus={focusIn}
              onBlur={focusOut}
      ...
      {!showAddForm && (
        ...
        >
          ...
          >
            <span
              style={{ fontSize: "15px", fontWeight: "600", color: "#111" }}
            >
              All Offers
            </span>
            <button
